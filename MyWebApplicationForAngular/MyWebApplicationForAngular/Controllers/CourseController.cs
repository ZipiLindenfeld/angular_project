...
namespace Server.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        {
            var c = courses.Find(c => c.Id == value.Id);
            if (c != null)
            {
                c.Name = value.Name;
                ...
                c.LearningType = value.LearningType;
